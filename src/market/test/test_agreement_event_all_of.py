...
import market
from market.models.agreement_event_all_of import AgreementEventAllOf  # noqa: E501
...
class TestAgreementEventAllOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = market.models.agreement_event_all_of.AgreementEventAllOf()  # noqa: E501
        if include_optional :
            return AgreementEventAllOf(
                agreement = market.models.agreement.Agreement(
                    agreement_id = '0', 
                    demand = None, 
                    offer = None, 
