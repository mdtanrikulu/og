...
class RequestorApi(object):
    ...
    def collect_offers(self, subscription_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: list[OneOfProposalEventPropertyQueryEvent]
        """
        kwargs['_return_http_data_only'] = True
    ...
    def collect_offers_with_http_info(self, subscription_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[OneOfProposalEventPropertyQueryEvent], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def create_agreement(self, agreement_proposal, **kwargs):  # noqa: E501
        ...
        :param agreement_proposal: (required)
        :type agreement_proposal: AgreementProposal
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def get_demands_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[OneOfDemand], status_code(int), headers(HTTPHeaderDict))
        """
