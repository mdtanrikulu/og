...
class PropertyQueryEventAllOf(object):
    ...
    def __init__(self, property_query=None, local_vars_configuration=None):  # noqa: E501
        ...
        if property_query is not None:
            self.property_query = property_query

    @property
    def property_query(self):
        """Gets the property_query of this PropertyQueryEventAllOf.  # noqa: E501


        :return: The property_query of this PropertyQueryEventAllOf.  # noqa: E501
        :rtype: PropertyQuery
        """
        return self._property_query

    @property_query.setter
    def property_query(self, property_query):
        """Sets the property_query of this PropertyQueryEventAllOf.


        :param property_query: The property_query of this PropertyQueryEventAllOf.  # noqa: E501
        :type property_query: PropertyQuery
        """

        self._property_query = property_query
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PropertyQueryEventAllOf):
            return False
