...
class ProposalAllOf(object):
    ...
    def proposal_id(self):
        """Gets the proposal_id of this ProposalAllOf.  # noqa: E501


        :return: The proposal_id of this ProposalAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def proposal_id(self, proposal_id):
        """Sets the proposal_id of this ProposalAllOf.


        :param proposal_id: The proposal_id of this ProposalAllOf.  # noqa: E501
    ...
    @property
    def issuer_id(self):
        """Gets the issuer_id of this ProposalAllOf.  # noqa: E501


        :return: The issuer_id of this ProposalAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def issuer_id(self, issuer_id):
        """Sets the issuer_id of this ProposalAllOf.


        :param issuer_id: The issuer_id of this ProposalAllOf.  # noqa: E501
        :type issuer_id: str
        """
    ...
    @property
    def state(self):
        """Gets the state of this ProposalAllOf.  # noqa: E501
        ...
        * `Initial` - proposal arrived from the market as response to subscription * `Draft` - bespoke counter-proposal issued by one party directly to other party (negotiation phase) * `Rejected` by other party * `Accepted` - promoted into the Agreement draft * `Expired` - not accepted nor rejected before validity period   # noqa: E501
        ...
        :return: The state of this ProposalAllOf.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this ProposalAllOf.
    ...
    def prev_proposal_id(self):
        """Gets the prev_proposal_id of this ProposalAllOf.  # noqa: E501

        id of the proposal from other side which this proposal responds to   # noqa: E501

        :return: The prev_proposal_id of this ProposalAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def prev_proposal_id(self, prev_proposal_id):
        """Sets the prev_proposal_id of this ProposalAllOf.

        id of the proposal from other side which this proposal responds to   # noqa: E501

        :param prev_proposal_id: The prev_proposal_id of this ProposalAllOf.  # noqa: E501
        :type prev_proposal_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProposalAllOf):
            return False
